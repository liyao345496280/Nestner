...
if args.model_name is None:
    if 'FIVE' in args.dataset_name:
        args.model_name = 'dmis-lab/biobert-v1.1'
    elif args.dataset_name in ('ace2004', 'ace2005'):
        args.model_name = 'bert_base_cased'
    else:
        args.model_name = 'bert-large'
...
model = Ner(model_name, num_ner_tag=matrix_segs['ent'], cnn_dim=args.cnn_dim, biaffine_size=args.biaffine_size,
